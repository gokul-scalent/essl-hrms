...
func (r *EmployeeRepoImpl) CreateEmployee(ctx context.Context, employee entity.Employee) (int, errors.Response) {
	...
	//STEP 2:Get the actual users.id generated by MySQL.
	...
	_, err = tx.Exec(
		`		INSERT INTO user_roles (user_id,role_id	) VALUES (?, ?)`, employee.UID, employeeRoleID,
	)
	...
	employeeQuery := `
		INSERT INTO employees (	uid, emp_id,	emp_name, privilege,	password,	group_id,card) VALUES (?, ?, ?, ?, ?, ?, ?)
	`
